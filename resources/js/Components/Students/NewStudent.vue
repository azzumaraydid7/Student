...
const add = () => {
    ...
    axios.post("/api/add-student", formData)
    .then((response) => {
    ...
    <div class="max-w-xl mx-auto py-10">
        ...
        <form class="mt-8">
            <div class="mx-auto w-full">
                <div class="mt-8 text-center cursor-pointer relative">
                    <img :src="getPhoto()" alt="" class="m-auto rounded-full object-cover w-28 h-28">
                ...
                <div class="py-1 space-y-2">
                    ...
                    <div>
                        <span class="px-1 text-sm text-gray-600">Register No</span>
                ...
                <button @click="add()" :disabled="loading" type="button" class="flex justify-center items-center rounded-lg bg-green-700 px-4 py-2 text-white disabled:opacity-70 disabled:cursor-not-allowed">
                    ...
                    <span v-else class="flex">
                        <span class="font-medium"> Create Student </span>
                    </span>
                </button>
            </div>
        </form>
